...
| `warning` | Show/hide warnings produced by code in the output        | `true`       |
...
-   Add a code chunk to calculate the largest recorded bill length of an Adelie penguin i.e.
```{r}
#| echo: true
#| eval: false
...
- Use inline code to give give the largest recorded bill length of an Adelie penguin
:::
```{r}
countdown::countdown(minutes = 15,
                    color_border = "#5b868d",
